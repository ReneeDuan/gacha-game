...
<body>
    ...
    <button class="purchase-button" onclick="purchasePackage1()">Purchase Package 1 (¥20, 10 draws, 1% rare)</button>
    <button class="purchase-button" onclick="purchasePackage2()">Purchase Package 2 (¥20, 1 draw, 10% rare)</button>
